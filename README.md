...
4. Открыть https://game-trade-hub-worker.gromakoff.workers.dev/ — там есть ссылки на регистрацию и Telegram-авторизацию. При необходимости переопределите базу через `?apiBase=`.
